...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() throws Exception {
		Method catmethod = r.getClass().getDeclaredMethod("getCat", int.class);
    	catmethod.setAccessible(true);
    	Object ret = catmethod.invoke(r, 2);


    	// Postconditions: Return value is null
    	assertNull(ret);

    	// Assert that the expected message "Invalid cat ID." is printed to the output
	...
	public void testRenameNumCat3() {
		...
		// int id = c2.getId();
		// Mockito.when(c2.toString()).thenReturn("ID " + id + ". " + name);
	...
	private void assertEqauls(boolean b, boolean c) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'assertEqauls'");
	}
