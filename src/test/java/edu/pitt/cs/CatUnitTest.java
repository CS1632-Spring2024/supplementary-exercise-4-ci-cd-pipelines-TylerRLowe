...
public class CatUnitTest {
	...
	public void setUp() throws Exception {
		this.c = Cat.createInstance(InstanceType.IMPL, 1, "Jennyanydots");
	...
	public void testGetName() {
		// TODO: Fill in
		assertEquals("Jennyanydots",this.c.getName());
	...
	public void testGetRented() {
		// TODO: Fill in
		assertEquals(false,this.c.getRented());
	...
	public void testToString() {
		assertEquals("ID 1. Jennyanydots",this.c.toString());
	...
	public void testRentCat() {
		c.rentCat();
		assertEquals(true,this.c.getRented());
	...
	public void testRenameCat() {
		...
		assertEquals("Garfield",this.c.getName());
		// TODO: Fill in
	}
